"""
gender Group Pie Chart — no numbers or percentages inside the pie
...
ax.set_title(f"Gender Group Distribution (n={total})", pad=16)
...
ax.legend(wedges, legend_labels, title="Gender (counts)", loc="center left", bbox_to_anchor=(1, 0.5))

plt.tight_layout()

# Save a high-resolution image to the current directory
plt.savefig("gender_group_pie.png", bbox_inches="tight")
